				...
				<section id="banner">
					<div class="content">
						...
						<div class="mypageContent">
							<form action="hosquitprocess.do" method="post">
								<div class="signoutpassck">
								 
								<i class="far fa-frown-open"></i><p class="signoutmsg">정말 탈퇴하시겠습니까?</p>
								<div id="passckbox">
									<div class="passck1">비밀번호 확인</div>
									<input type="password" class="passck2"  name="password">
								</div>
							  	<div class="signoutsubbtn">
							  		<button type="button" class="passckbtn_" onclick="javascript:history.go(-1);">취소</button>
