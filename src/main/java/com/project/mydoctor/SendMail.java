...
public class SendMail { 
	...
	public String mailSending(@RequestParam("name") String name, @RequestParam("id") String id, @RequestParam("email") String email, 
		...
		if(key==1) {
		 ...
		 content = "임시비밀번호는 "+uuid+" 입니다."; // 내용
				  ...
				  out.println("<script>alert('임시비밀번호로 업데이트 실패');");
					 out.println("location.href='main'");	
					 out.println("</script>");
					 out.close();
			  }
